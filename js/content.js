...
/**
 * consolidateHtml - takes in a string of html gotten from curl on genius lyric 
 * page and splices out only the lyrics section defined by content between
 * .lyrics_container and .song_footer
 ...
 * will send a message to the background page which will handle the api call to 
 * genius based on the id of the annotation.
 * @author tbarker
 */
 ...
 * @return links - DOM obj of the relevanthtml with hrefs removed and ID added
 * @author tbarker
 */
...
/**
 * addLyricsToPage - overlays the lyrics returned from the genius API on the
 * comment section of the YouTube page.  TODO if youtube layout changes 
 * watch-discussions will have to be changed to the new id of the new comment
 * section.
